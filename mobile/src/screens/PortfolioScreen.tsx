...
export default function PortfolioScreen({ navigation }: any) {
  ...
  const fundBalance = Number((chama as any)?.investmentFundBalance || 0);
  const [activeTab, setActiveTab] = useState<
    "Holdings" | "Returns" | "History"
  >("Holdings");
  return (
        ...
        <View style={[S.hero, { backgroundColor: themeColor }]}>
          ...
          <View style={S.heroNav}>
            ...
            <View style={S.typePill}>
              <Text style={S.typePillText}>Investment</Text>
            </View>
          </View>

          <Text style={S.balanceLabel}>TOTAL FUND VALUE</Text>
          <Text style={S.balance}>Ksh {fundBalance.toLocaleString()}</Text>
        ...
        <View style={S.body}>
          ...
          <View style={S.tabSwitcher}>
            {(["Holdings", "Returns", "History"] as const).map((t) => (
              <Pressable
                key={t}
                style={[S.tabOpt, activeTab === t && S.tabOptActive]}
                onPress={() => setActiveTab(t)}
              >
                <Text
                  style={[S.tabOptText, activeTab === t && S.tabOptTextActive]}
                >
                  {t}
                </Text>
              </Pressable>
              ...
              <View style={S.section}>
                ...
                <View style={S.voteCard}>
                  ...
                  <Text style={S.voteTitle}>
                    Invest Ksh 200,000 in additional Equity Bank shares on NSE
                  </Text>
                  <View style={S.voteTallyRow}>
                    ...
                    <View style={[S.voteTally, { backgroundColor: Colors.background }]}>
                      <Text style={[S.vtNum, { color: "#9CA3AF" }]}>3</Text>
                      <Text style={[S.vtLbl, { color: "#9CA3AF" }]}>
                        Pending
                      </Text>
                    </View>
                  </View>
            ...
            <View style={S.section}>
              ...
              {HOLDINGS.map((p) => (
                <View key={p.id} style={[S.portItem, { marginTop: 12 }]}>
                  ...
                  <Text
                    style={[S.actSub, { color: "#059669", fontWeight: "700" }]}
                  >
                    {p.ret}
                  </Text>
                </View>
          ...
          {activeTab === "History" && (
            <View style={S.section}>
              ...
              {[
                "NSE Shares purchase — Mar 2024",
                "Rongai land deposit — Jun 2024",
                "CIC Unit Trust — Dec 2024",
              ].map((item, i) => (
                <View key={i} style={[S.portItem, { marginTop: 12 }]}>
                  <View
                    style={[
                      S.portDot,
                      { backgroundColor: [Colors.primary, Colors.accentDark, "#F59E0B"][i] },
                    ]}
                  />
